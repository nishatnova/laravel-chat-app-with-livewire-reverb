            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="container mx-auto p-8">
                        <h1 class="text-2xl text-black font-bold mb-4">List of users:</h1>
                            ...
                            <table class="table-auto w-full border-collapse border border-gray-300">
                                <thead>
                                    <tr class="bg-gray-100">
                                        <th class="border border-gray-300 text-black px-4 py-2 text-left w-12">#</th>
                                        <th class="border border-gray-300 text-black px-4 py-2 text-left">Name</th>
                                        <th class="border border-gray-300 text-black px-4 py-2 text-left">Email</th>
                                        <th class="border border-gray-300 text-black px-4 py-2 text-left w-32">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @forelse ($users as $user)
                                        <tr>
                                            <td class="border border-gray-300 text-black px-4 py-2">{{ $loop->index + 1 }}</td>
                                            <td class="border border-gray-300 text-black px-4 py-2">{{ $user->name }}</td>
                                            <td class="border border-gray-300 text-black px-4 py-2">{{ $user->email }}</td>
                                            <td class="border border-gray-300 text-black px-4 py-2">
